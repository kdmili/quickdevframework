...
import org.lm.quick.entity.Home;
import org.lm.quick.entity.Recorded;
...
public class TestUtil extends BaseTest {
	...
	public void parse_entity_info() throws Exception {
		List<ColumnMeta> info = EntityUtil.getColumnMeta(em.getMetamodel(), Users.class);
		Assert.notNull(info);
	...
	public static void main(String[] args) throws NoSuchFieldException, SecurityException {
		...
		Field f = EntityUtil.getColumnField(Users.class, "recordInfo");
		System.out.println(f.getName());
		  f = EntityUtil.getColumnField(Users.class, "recordInfo.createDate");
		System.out.println(f.getName());
